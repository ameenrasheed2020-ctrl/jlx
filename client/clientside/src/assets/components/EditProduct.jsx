...
const EditProduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:6500/product/updateproduct/${id}`, {
                    ...
                    <div className="form-group">
                        ...
                        {(imagePreview || existingImage) && (
                            <div className="image-preview-container mt-2">
                                <img src={imagePreview || `http://localhost:6500/uploads/profiles/${existingImage}`} alt="Product" style={{ maxWidth: '100%', height: '150px', borderRadius: '8px' }} />
                            </div>
                        )}
                    </div>
